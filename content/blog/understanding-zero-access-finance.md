...
This post explains what that looks like in practice across Kura Wallet, Kura Card, and TrackFi.
...
## How it works in Kura Wallet

Kura Wallet uses **Privy MPC (multi-party computation)** to split key material across parties so no single entity — including Kura — can unilaterally sign transactions or recover your full private key.
