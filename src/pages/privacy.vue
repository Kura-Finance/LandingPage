    ...
    <div class="marketing-container max-w-3xl pb-20 md:pb-28">
      <div class="prose max-w-none space-y-8">
        ...
        <section>
          ...
          <p class="text-kura-text-secondary leading-relaxed">
            We use data solely to provide and secure the Service — including wallet provisioning, trading and transfers, yield vault facilitation, borrow market facilitation, card and fiat ramp facilitation, account aggregation, subscriptions, referrals, and analytics you request. We do not sell your personal or financial data, and we do not use your financial records for advertising, ad targeting, or behavioral profiling.
          </p>
        </section>
        ...
        <section>
          ...
          <ul class="list-disc pl-6 mt-3 space-y-2 text-kura-text-secondary leading-relaxed">
            ...
            <li><span class="font-semibold text-kura-text">Morpho</span> — DeFi yield vaults, lending/borrow markets, and related on-chain data.</li>
...
usePageSeo({
  title: 'Privacy Policy',
  description: 'Kura Finance privacy policy covering self-custody wallet, TrackFi encryption, partner integrations, and zero-access data handling.',
  path: '/privacy',
  keywords: 'privacy policy, zero-access, data protection, Kura Finance legal',
});
</script>
