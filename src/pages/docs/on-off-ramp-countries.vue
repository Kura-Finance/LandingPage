...
usePageSeo({
  ...
  description: 'Fiat on-ramp and off-ramp country coverage for Kura — Bridge.xyz bank rails and MoonPay debit/credit card purchases.',
  path: '/docs/on-off-ramp-countries',
  keywords: 'Bridge.xyz countries, MoonPay countries, fiat on-ramp, off-ramp, Kura deposits',
})
</script>

<template>
  <CoverageCountriesPage
    badge="Kura · Bridge.xyz & MoonPay"
