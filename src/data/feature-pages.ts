import { WEB_APP_URL } from '~/utils/site'
...
const defaultCta = {
  ...
  primaryTo: '/download',
  secondaryLabel: 'Pro Dashboard',
  secondaryTo: WEB_APP_URL,
}
...
export const FEATURE_PAGES = {
    ...
    sections: [
      {
        ...
        features: [
          ...
          { title: 'Business & Team', description: 'Shared Treasury, Approvals, Team, and Reports.', to: '/business' },
        ],
      },
    ],
    cta: defaultCta,
  ...
  business: {
    seo: {
      title: 'Business & Team',
      description:
        'Run company cash with shared Treasury, Approvals, Team roles, and Reports — available on the Kura web dashboard with Pro or Ultimate.',
      path: '/business',
      keywords: 'business treasury, team approvals, org finance, multi-owner, Kura business',
    },
    hero: {
      eyebrow: 'Business & Team',
      title: 'Company cash, shared control',
      description:
        'Fund a shared Treasury, propose payments for co-signers, manage Team roles, and export Reports — built for operators who need clarity without giving up custody.',
      tags: ['Treasury', 'Approvals', 'Team', 'Report'],
    },
    heroActions: [
      { label: 'Pro Dashboard', to: WEB_APP_URL, primary: true },
      { label: 'Get Pro', to: '/pricing' },
    ],
    callout: {
      label: 'Web dashboard',
      title: 'Business & Team requires Pro or Ultimate',
      description:
        'The full web experience — including Treasury, Approvals, Team, and Report — is available on Pro and Ultimate. The mobile app remains free for everyday personal use.',
    ...
    sections: [
      {
        label: 'Capabilities',
        title: 'Everything your team needs to move money together',
        description:
          'A focused set of org tools on the web dashboard — not a separate bank product, and not a second set of apps to learn.',
        columns: 2,
        features: [
          {
            title: 'Treasury',
            subtitle: 'Shared company funds',
            description:
              'Create or import a multi-owner Treasury Safe. Fund it, track holdings, and keep company cash separate from personal balances.',
          },
          {
            title: 'Approvals',
            subtitle: 'Propose → sign → execute',
            description:
              'Queue USDC payments and other Treasury actions for co-signers. See what’s waiting, who’s signed, and what still needs action.',
          },
          {
            title: 'Team',
            subtitle: 'Roles and owners',
            description:
              'Invite members, assign roles, and sync Safe owners. Keep who can propose and who can sign aligned with how your company actually works.',
          },
          {
            title: 'Report',
            subtitle: 'Cash flow clarity',
            description:
              'View period summaries and export activity for Treasury and connected sources — so ops and finance share the same picture.',
          },
        ],
      },
    ],
    cta: {
      title: 'Ready for Business & Team?',
      description: 'Open the Pro Dashboard for Treasury and Approvals, or upgrade if you still need a plan.',
      primaryLabel: 'Pro Dashboard',
      primaryTo: WEB_APP_URL,
